...
int main(void)
{
  ...
  /* USER CODE END SysInit */
	...
	while (1) {
	    ...
	    float altitude1 = MS5611_getAltitude1(MS5611.P / 100.0f);
	    float altitude2 = MS5611_getAltitude2(MS5611.P  / 100.0f, MS5611.TEMP / 100.0f);



	    char tempRawStr[20];
	    sprintf(tempRawStr, "Raw Temp: %d", MS5611.TEMP);
	    ...
	    LCD_SendString(&lcd, tempRawStr);


	    LCD_SetCursor(&lcd, 0, 1);
	    LCD_SendString(&lcd, altStr2);
	    LCD_SetCursor(&lcd, 0, 2);
	    LCD_SendString(&lcd, altStr2);


	    LCD_SetCursor(&lcd, 0, 3);
	    LCD_SendString(&lcd, pressStr);
